...
<article class="module width_full">
    <header><h3>Thêm sự kiện nổi bật</h3></header>
        <div class="module_content">
            <form id="frm_high_light" name="frm_high_light" method="post" action="<?php echo $this->Html->url(array('controller' => 'Admin', 'action' =>'editHighlight', $data['id'])) ?>" class="login-subscription" enctype="multipart/form-data">
                <fieldset>
