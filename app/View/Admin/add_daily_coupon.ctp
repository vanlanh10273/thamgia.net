...
<article class="module width_full">
    <header><h3>Thêm sự kiện nổi bật</h3></header>
        <div class="module_content">
            <form id="frm_daily_coupon" name="frm_daily_coupon" method="post" action="<?php echo $this->Html->url(array('controller' => 'Admin', 'action' =>'addDailyCoupon')) ?>" class="login-subscription" enctype="multipart/form-data">
                <fieldset>
                ...
                <fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
                    ...
                    <input type="text"  style="width:92%;"  id="end" name="data[DailyCoupon][discount]" value="<?php echo isset($data['fee']) ? $data['fee'] : '' ?>" class="validate[required]" />
                </fieldset>
                <div class="clear"></div>
                <div>
                    <?php echo $this->fck->ckeditor(array('DailyCoupon', 'description'), $this->webroot, ''); ?>
                </div>
