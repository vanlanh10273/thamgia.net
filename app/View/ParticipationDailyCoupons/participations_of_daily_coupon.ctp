...
<div class="content-center">
    ...
    <div class="personal-information-new-02">
        <div class="wd-section">
            <p class="titel-text">Đã có <?php echo $number_of_participation ?> người tham gia daily coupon <a href="<?php echo $this->Html->url(array('controller' => 'DailyCoupons', 'action' =>'detail', 'slug' => Link::seoTitle($daily_coupon_title), 'id' => $daily_coupon_id)); ?>"><?php echo $daily_coupon_title; ?></a></p>
...
<div class="fancybox-none">
    ...
    <div id="content-all-message" class="message-fancybox">
        ...
        <form id="frm_subscription2" name="frm_subscription2" method="post" onsubmit="return validateAllMessageBox();" action="<?php echo $this->Html->url(array('controller'=>'Messages', 'action' => 'sendMessageToAllMemberOfDailyCoupon', $daily_coupon_id)) ?>" class="login-subscription">
            <fieldset>
                <ul>
                    <li>
