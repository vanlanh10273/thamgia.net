...
<article class="module width_full">
    <header><h3>Thêm user</h3></header>
        <div class="module_content">
            <form id="frm_email" name="frm_user" method="post" action="<?php echo $this->Html->url(array('controller' => 'AccountEmails', 'action' =>'add')) ?>" class="login-subscription" enctype="multipart/form-data">
