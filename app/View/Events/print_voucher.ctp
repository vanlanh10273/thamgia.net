...
.communication-voucher {background:url(<?php echo $this->Html->url('/')?>img/bg-voucher-01.png) no-repeat center; width:424px; height:90px;margin-left: 159px; position:relative;margin-top:18px}
...
span.promotion { 
    position:absolute; top: 124px; left:128px; width:142px; 
    background:url(<?php echo $this->Html->url('/')?>img/bg_saleoff_big.png) no-repeat center; 
    font-size:29px; 
    text-align:center;
...
.communication-voucher-01 .communication-right {position: absolute; left:305px; width:55%;}
.communication-voucher-01 .communication-right span{font-size:13px; color:#000; line-height:17px;margin:0px; text-align:left;font-style: italic;font-weight:bold;}
...
a.in { display:block; width:45px; height:44px;background:url(<?php echo $this->Html->url('/')?>img/bg-shared.png) no-repeat right -2651px;float:left }
...
<div id="fancybox-voucher" class="voucher">
        <div class="voucher-01">
            <h3><span>DAILY COUPON</span> - <?php echo $event_title; ?></h3>
            <p class="day"><?php echo $event_summary; ?></p>
            ...
            <span style="color:#fff;" class="promotion"><?php echo $event_fee; ?></span>
            <div class="communication-voucher-01">
                <div class="communication-left">
                    <p>Áp dụng: từ ngày <span><?php echo $event_start ?></span> đến ngày<span><?php echo $event_end; ?></span></p>
                    <p>Địa điểm: <?php echo $event_address; ?></p>
                </div>
