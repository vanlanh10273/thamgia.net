<?php
    ...
    $data = $this->requestAction(array('controller' => 'Events', 'action' => 'getEventsLatest', $city_id));
?>
<div class="update-new">
    ...
    <ul class="new-content">
        ...
        ?>
        <li>
            <a href="<?php echo $url_detail;?>"><img src="<?php echo $this->Html->url('/') . (isset($item['Event']['image_url']) ? $item['Event']['image_url'] : NO_IMG_URL);  ?>" alt="Image"  /></a>
