...
window.console.log('[cycle] '+Array.prototype.join.call(arguments,' '));};$.fn.cycleOpts={};$.fn.cycle=function(options,arg2){var o={s:this.selector,c:this.context};if(this.length==0&&options!='stop'){if(!$.isReady&&o.s){log('DOM not ready, queuing slideshow')
...
var opts=buildOptions($cont,$slides,els,options,o);$.fn.cycleOpts=opts;if(opts===false)
